...
<link rel="stylesheet" type="text/css" href="<%=basePath %>/style/css/index_1.css" />
	...
	* {
	...
	#dish_2 li{
		background:url(<%=basePath %>/style/images/img/btn.gif);
		width:164px;
		height:47px;
		text-align:center;
		padding-top:5px;
...
<body style="text-align: center">
	...
	<div class="index_all" style="text-align:center;">
		<!--上面的背景层-->
		<div>
			<img src="<%=basePath %>/style/images/flower.gif" />
		</div>
		<!--中间层-->
		<div id="index_center">
			<!--中间层的空白层-->
			...
			<div>
				...
				<div class="bg_middle">
					<img
						src="<%=basePath %>/style/images/index_menu.gif"
						border="0" usemap="#Map" />
					<map name="Map" id="Map">
			...
			<div id="center_bottom">
				...
				<c:forEach items="${list }" var="l">				
					<li>
						<a href="<%=contextPath %>/frontController?method=getFoodList&id=${l.id}">
							${l.tableName }&nbsp;
						</a>
					</li>
				</c:forEach>																				
