	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="<%=request.getContextPath()%>/dinnerTableController?method=getDinnerTableList">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="<%=request.getContextPath()%>/cuisineController?method=getCuisineList">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="<%=request.getContextPath()%>/foodController?method=getFoodList">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="<%=request.getContextPath()%>/orderController?method=getOrderList">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
