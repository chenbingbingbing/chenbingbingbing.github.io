...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="<%=basePath %>/style/images/title_arrow.gif"/>  添加新桌
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="<%=contextPath %>/dinnerTableController?method=saveBoard" method="post">
		<!-- 本段标题（分段标题） -->
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="<%=basePath %>/style/images/item_point.gif"> 新桌信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
