...
<title>无线点餐后台管理</title>
	...
	<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
		<frame src="common/top.jsp" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame noresize src="common/left.jsp" scrolling="yes" /> 
			<frame noresize name="right" src="common/right.jsp" scrolling="yes" /> 
		</frameset>
		<frame noresize name="status_bar" scrolling="no" src="common/bottom.jsp" />
	</frameset>
	<noframes>
		<body>
