...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">											
			<img border="0" width="13" height="13" src="<%=basePath %>/style/images/title_arrow.gif"/> 添加新菜品							
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="<%=contextPath %>/foodController?method=addFood" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
